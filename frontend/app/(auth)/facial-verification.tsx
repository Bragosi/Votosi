...
export default function FacialVerificationScreen() {
  ...
  const handleCapture = async () => {
    ...
    try {
      // Take the photo (URI available for future AI upload)
      await cameraRef.current.takePictureAsync({ quality: 0.7 });
      setStage('verifying');

      // Simulate AI model processing delay (2.5 s)
      setTimeout(() => {
        // TODO: replace with real model API call when ready
        // const result = await aiService.verify(photo.uri);
        setStage('success');
      ...
      <SafeAreaView style={styles.container}>
        <View style={styles.center}>
          ...
          <Text style={styles.subtitle}>
            Votosi needs your camera to verify your identity before you can log in.
          ...
          <View style={styles.mockBadge}>
            ...
            <Text style={styles.mockText}>Mock mode — AI model in training</Text>
          </View>
        </View>
      </SafeAreaView>
    );
    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.center}>
          ...
          <View style={styles.mockBadge}>
            <Ionicons name="flask-outline" size={13} color={Colors.warning} />
            <Text style={styles.mockText}>Mock mode — always succeeds</Text>
          </View>
        </View>
      </SafeAreaView>
    );
    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.center}>
          ...
          <Text style={styles.subtitle}>Welcome to Votosi. Setting up your session…</Text>
        </View>
      </SafeAreaView>
    );
  }
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.mockBadgeInline}>
          ...
          <Text style={styles.mockTextSmall}>Mock</Text>
        </View>
      </View>
